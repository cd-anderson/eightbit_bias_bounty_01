...
class EightBitAgeModel(EightBitModel):
    config = get_config({
        'algorithm': 'fixmatch',
        ...
        'save_name': 'bbc01_age_vit_small_patch16_224',
        'load_path': './saved_models/bbc01_age_vit_small_patch16_224/model_best_eightbit.pth',
        'resume': True,
